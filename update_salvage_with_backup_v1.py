# file: update_salvage_salvagepotential.py
import os
import json
import shutil

# ======== USER CONFIG ========
TARGET_DIR = r"F:\Internet\Steam\steamapps\common\BATTLETECH\Mods"  # <-- your mod folder
...
print(f"\nUpdated SalvagePotential in {len(updated_files)} files.")
